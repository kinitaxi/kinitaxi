...
namespace AcxiDriver.Adapter
{
    class TripAdapter : RecyclerView.Adapter
    {
        ...
        public override RecyclerView.ViewHolder OnCreateViewHolder(ViewGroup parent, int viewType)
        {
            ...
            itemView = LayoutInflater.From(parent.Context).Inflate(Resource.Layout.trip_item, parent, false);
        ...
        public override void OnBindViewHolder(RecyclerView.ViewHolder viewHolder, int position)
        {
            ...
            if(items[position].created_at != null)
            {
            ...
            {
                holder.tripdate.Text = "Not Available";
            }

            if(items[position].status != null)
            {
            ...
            {
                holder.tripstatus.Text = "Not Available";
            }
